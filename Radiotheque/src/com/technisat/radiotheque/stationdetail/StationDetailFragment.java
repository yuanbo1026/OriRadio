...
public class StationDetailFragment extends Fragment {
	...
	private void initUI(){
		if (mCurrentStation != null){
			...
			if (mCurrentStation.getBuyLinkAmazon() == null){
				...
				mIvBuyIcon.setImageResource(R.drawable.ic_buy_false);
			} else {
				mIvBuyIcon.setImageResource(R.drawable.ic_buy_true);
	...
	public void setFavIcon(boolean isFav){
		if (isFav){
			mIvFavIcon.setImageResource(R.drawable.ic_favs_true);
		} else {
			mIvFavIcon.setImageResource(R.drawable.ic_favs_false);				
		}
	}
